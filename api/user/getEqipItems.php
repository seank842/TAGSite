...
if(missingOperand($operand,$_POST)){
	...
	$query="SELECT o.OwnershipID,o.ItemID,i.Name AS ItemName ,i.Value, i.ImageURL, i.TypeID, t.Name AS TypeName, i.SlotID, s.Name AS SlotName
	...
	WHERE o.UserID = $userID AND o.OwnershipID NOT IN (SELECT OwnershipID FROM tbl_equip)";
